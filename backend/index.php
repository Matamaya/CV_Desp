...
$datosCV = [
    ...
    "sobre_mi" => "Desarrollador web con pasión por construir aplicaciones altamente interactivas, limpias y eficientes. Especializado en el desarrollo frontend con React y ecosistemas backend con PHP y bases de datos relacionales.",
    "proyecto_ejemplo" => [
